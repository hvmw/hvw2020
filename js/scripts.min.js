...
strokeOpacity:1,strokeWeight:2});var f={zoom:14,minZoom:2,scrollwheel:!1,panControl:!1,draggable:!0,zoomControl:!1,zoomControlOptions:{position:google.maps.ControlPosition.RIGHT_TOP},scaleControl:!1,mapTypeControl:!1,streetViewControl:!1,center:centerMap,mapTypeControlOptions:{mapTypeIds:[google.maps.MapTypeId.ROADMAP,"custom_style"]},mapTypeId:"custom_style"};768>a(window).width()&&(f.center=mobileCenterMap);"logistics"==googleMaps&&(f.zoom=5,f.zoomControl=!0);c=new google.maps.Map(document.getElementById("canvas-map"),
f);var t=new google.maps.Marker({position:eventPlace,animation:google.maps.Animation.DROP,icon:icon,map:c});l.push(t);var f=new google.maps.StyledMapType([{stylers:[{lightness:40},{visibility:"on"},{gamma:.9},{weight:.4}]},{elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"water",stylers:[{color:"#5dc7ff"}]},{featureType:"road",stylers:[{visibility:"on"}]}],{name:"Default Style"}),w=new google.maps.StyledMapType([{stylers:[{lightness:40},{visibility:"on"},{gamma:1.1},{weight:.9}]},
{elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"water",stylers:[{color:"#5dc7ff"}]},{featureType:"road",stylers:[{visibility:"on"}]},{featureType:"road",elementType:"labels",stylers:[{saturation:-10}]}],{name:"Zoomed Style"});c.mapTypes.set("default",f);c.mapTypes.set("zoomed",w);"logistics"===googleMaps?(c.setMapTypeId("default"),f=document.getElementById("location-input"),q=new google.maps.places.Autocomplete(f),google.maps.event.addListener(q,"place_changed",function(){t.setVisible(!1);
